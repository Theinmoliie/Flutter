  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (e.message.toLowerCase().contains('email not confirmed')) {
        ...
        // This is crucial to clean up the bad session.
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Log In", textAlign: TextAlign.center, style: textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold, color: colorScheme.onBackground)),
                const SizedBox(height: 30),
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(onPressed: () => Navigator.pushReplacementNamed(context, '/register'), style: TextButton.styleFrom(foregroundColor: colorScheme.primary, padding: const EdgeInsets.symmetric(horizontal: 4.0)), child: const Text("Sign Up")),
                  ],
                ),
              ],
            ),
